...
router.post('/Admin/product/new', isAuthenticatedUser, authorizeRoles('admin'),
  newProduct)

router.put('/Admin/updateproduct/:id', isAuthenticatedUser, authorizeRoles('admin'),
  updateproduct)
